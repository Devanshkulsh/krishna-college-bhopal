        ...
        <section className="w-full bg-white py-6 md:py-8 lg:py-12">
          ...
          ====================================================== */}
                    <div className="h-full">
                        <div className="h-full min-h-[280px] overflow-hidden border border-gray-200 bg-gray-100 sm:min-h-[350px] md:min-h-[400px] lg:min-h-[650px] xl:min-h-[700px]">
                            <img
                                src="/hero/campus.png"
          ...
          ====================================================== */}
                    <div className="flex h-full flex-col gap-3 sm:gap-4">
                        ...
                        {/* TOP IMAGE */}
                        <div className="min-h-[160px] flex-1 overflow-hidden bg-gray-100 sm:min-h-[200px] md:min-h-[240px] lg:min-h-0">
                            <img
          ...
          ====================================================== */}
                    <div className="flex flex-col justify-center py-4 lg:pl-3 xl:pl-4">
                        ...
                        {/* SMALL TITLE */}
                        <p className="mb-3 text-[13px] font-medium uppercase tracking-[0.5px] text-[#00a936] sm:text-[14px] md:text-[16px] md:mb-4 lg:text-[18px]">
            ...
            ================================================== */}
                        <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:gap-10">
                            ...
                            {/* MISSION */}
                            <div>
                                <h3 className="mb-2 text-[18px] font-bold text-[#101f62] sm:text-[19px] md:text-[20px] md:mb-3">
                                    Our Mission
                                </h3>

                                <p className="text-[14px] leading-[1.7] text-black sm:text-[15px] md:text-[16px] md:leading-[1.8]">
