...
const HospitalStaff = () => {
  const pdfPath = "/hero/hospital.pdf";
      ...
      <section className="py-14 md:py-16">
        ...
        <div className="mx-auto max-w-[1500px] px-5 md:px-8 lg:px-12">
          ...
          <div className="mx-auto max-w-[950px] text-center">
            ...
            {/* ICON */}
            <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#eaf7f4] text-[#168486]">
              <Stethoscope size={31} />
            </div>
            ...
            <p className="mt-5 text-[16px] leading-8 text-gray-600">
              View the official information related to the hospital staff of
              Shri Krishna Ayurvedic Hospital. Complete staff information is
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="mt-2 max-w-[650px] text-sm leading-6 text-gray-600 md:text-base">
                  View or download the official Hospital Staff document
      ...
      <section className="bg-[#f5faf9] py-16 md:py-20">
        ...
        <div className="mx-auto max-w-[1400px] px-5 md:px-8 lg:px-12">
          ...
          <div className="mb-9 text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-[#14245f] md:text-4xl">
              View Hospital Staff Document
            </h2>

            <p className="mx-auto mt-4 max-w-[750px] text-base leading-7 text-gray-600">
              The official Hospital Staff document can be viewed directly
              below. You can also open the complete PDF separately in a new
              browser tab.
            </p>
        ...
        >
          ...
          <div>
            ...
            <p className="mt-3 max-w-[700px] leading-7 text-white/80">
              Our hospital team works together to provide quality healthcare,
              clinical support and compassionate patient care.
            </p>
