    ...
    <main className="w-full bg-white">
              ...
              return (
                <div
                  ...
                  className="
                    ...
                    duration-300
                    hover:-translate-y-2
                    hover:shadow-[0_18px_45px_rgba(0,0,0,0.13)]
                  "
                >
                  {/* ICON */}
                  <div
                  ...
                  {item.type === "phone" ? (
                    ...
                    <p className="mt-3 flex-1 text-sm font-medium leading-7 text-[#374151]">
                      {item.content}
                    </p>
                  )}
      ...
      <section className="bg-[#0a756d] py-14">
        <div className="mx-auto flex max-w-[1400px] flex-col items-center justify-between gap-7 px-5 text-center md:px-8 lg:flex-row lg:px-12 lg:text-left">
          ...
          >
            Hospital Helpline: +91-6262618031
          </a>
        </div>
      </section>
    </main>
