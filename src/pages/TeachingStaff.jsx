...
const TeachingStaff = () => {
  const pdfPath = "/hero/Teaching.pdf";
        ...
        <div className="mx-auto max-w-[1500px] px-5 md:px-8 lg:px-12">
          ...
          <div className="mx-auto max-w-[950px] text-center">
            ...
            <p className="mt-5 text-[16px] leading-8 text-gray-600">
              View the official information related to the teaching faculty of
              Shri Krishna Ayurvedic Hospital. Complete faculty details are
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="mt-2 max-w-[650px] text-sm leading-6 text-gray-600 md:text-base">
                  View or download the official Teaching Staff document
                  containing complete faculty information.
                </p>
        ...
        <div className="mx-auto max-w-[1400px] px-5 md:px-8 lg:px-12">
          ...
          <div className="mb-9 text-center">
            ...
            <p className="mx-auto mt-4 max-w-[750px] text-base leading-7 text-gray-600">
              The official Teaching Staff document can be viewed directly
        ...
        >
          ...
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold text-white md:text-3xl">
              Learn From Experienced Ayurvedic Faculty
            </h2>

            <p className="mt-3 max-w-[700px] leading-7 text-white/80">
              Our faculty members support students through quality academic
              teaching, practical learning, clinical exposure and professional
              guidance.
            </p>
